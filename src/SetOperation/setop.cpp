...
#define PROTOTYPE_SET(Scalar)                                                  \
  ...
  template void Diff_Sort(const vector<Scalar> &vec1,                          \
                          const vector<Scalar> &vec2, vector<Scalar> &vec);    \
  template int FindIndex_Sort(const vector<Scalar> &vec, const Scalar value);  \
  template void FindAllIndex(const vector<Scalar> &vec, const Scalar value,    \
                             vector<int> &index);                              \
  template void FindAllIndex_Sort(const vector<Scalar> &vec1,                  \
                                  const vector<Scalar> &vec2,                  \
                                  vector<int> &index);                         \
  template bool Intersect_Sort(const vector<Scalar> &vec1,                     \
                               const vector<Scalar> &vec2);                    \
  template void Intersect_Sort(const vector<Scalar> &vec1,                     \
                               const vector<Scalar> &vec2,                     \
  ...
  template void Intersect_Sort(const vector<Scalar> &vec1,                     \
                               const vector<Scalar> &vec2,                     \
                               vector<Scalar> &vec);                           \
  template void Intersect_Sort(                                                \
      const vector<Scalar> &vec1, const vector<Scalar> &vec2,                  \
