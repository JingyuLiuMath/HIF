...
void HIFGraph<Scalar>::RecursiveApplySkelUp(int whatlevel,
  ...
  DEBUG_HIF(CallStackEntry cse("HIFGraph:RecursiveApplySkelUp"))
...
void HIFGraph<Scalar>::ApplySkelUp(const vector<int> &xcol) {
  DEBUG_HIF(CallStackEntry cse("HIFGraph:ApplySkelUp"))
  ...
  for (int k = 0; k < nbinfo_.size(); k++) {
    ...
    Gemm(TRANSPOSE, NORMAL, Scalar(-1), nbinfok.Th1c1,
    ...
    Gemm(TRANSPOSE, NORMAL, Scalar(-1), nbinfok.Th2c2,
    ...
    Gemm(TRANSPOSE, NORMAL, Scalar(-1), nbinfok.Ac1c1invAc1h1,
    ...
    copyvec = nbnodek.xS_(nbinfok.nodekindex_p22, xcol);
    Gemm(TRANSPOSE, NORMAL, Scalar(-1), nbinfok.Ac1c1invAc1c2,
         xS_(nbinfok.myindex_p12, xcol), Scalar(1), copyvec);
    SubMatrixUpdate(nbnodek.xS_, nbinfok.nodekindex_p22, xcol, copyvec);
    // xh2 = xh2 - (Ac1c1^{-1} * Ah2c1^{T})^{T} * xc1.
    copyvec = nbnodek.xS_(nbinfok.nodekindex_p21, xcol);
    Gemm(TRANSPOSE, NORMAL, Scalar(-1), nbinfok.Ac1c1invAc1h2,
         xS_(nbinfok.myindex_p12, xcol), Scalar(1), copyvec);
    ...
    copyvec = xS_(nbinfok.myindex_p11, xcol);
    Gemm(TRANSPOSE, NORMAL, Scalar(-1), nbinfok.Ac2c2invAc2h1,
         nbnodek.xS_(nbinfok.nodekindex_p22, xcol), Scalar(1), copyvec);
    SubMatrixUpdate(xS_, nbinfok.myindex_p11, xcol, copyvec);
    // xh2 = xh2 - (Ac2c2^{-1} * Ah2c2^{T})^{T} * xc2.
    copyvec = nbnodek.xS_(nbinfok.nodekindex_p21, xcol);
    Gemm(TRANSPOSE, NORMAL, Scalar(-1), nbinfok.Ac2c2invAc2h2,
         nbnodek.xS_(nbinfok.nodekindex_p22, xcol), Scalar(1), copyvec);
    SubMatrixUpdate(nbnodek.xS_, nbinfok.nodekindex_p21, xcol, copyvec);
    // xc2 = Lc2^{-1} * xc2.
    copyvec = nbnodek.xS_(nbinfok.nodekindex_p22, xcol);
