...
// Skeletonization.
template <typename Scalar> void HIFGraph<Scalar>::Skel() {
  ...
  for (int k = 0; k < nbnode_.size(); k++) {
    ...
    MatrixS skelmtx1;
    MatrixS skelmtx2;
    El::Zeros(skelmtx1, myindex_mysep1C.size() + myindex_mysep2C.size(),
              myindex_sep1.size());
    El::Zeros(skelmtx2,
              nodekindex_nodeksep2C.size() + nodekindex_nodeksep1C.size(),
    ...
    IDSolve(skelmtx1, T1, p11, p12,
            ctrl); // skelmtx1(:, p12) = skelmtx1(:, p11) * T1.
    ...
    IDSolve(skelmtx2, T2, p21, p22,
            ctrl); // skelmtx2(:, p22) = skelmtx2(:, p21) * T2.
    ...
    Gemm(TRANSPOSE, NORMAL, Scalar(1), ASS_(myindex_p11, myindex_p12), T1,
         Scalar(0), Ac1h1T1);
    Gemm(NORMAL, NORMAL, Scalar(1), ASS_(myindex_p11, myindex_p11), T1,
         Scalar(0), Ah1h1T1);
    Gemm(TRANSPOSE, NORMAL, Scalar(1),
         nodek.ASS_(nodekindex_p21, nodekindex_p22), T2, Scalar(0), Ac2h2T2);
    Gemm(NORMAL, NORMAL, Scalar(1), nodek.ASS_(nodekindex_p21, nodekindex_p21),
         T2, Scalar(0), Ah2h2T2);
    // Ac1c1 = Ac1c1 - Ah1c1^{T} * Th1c1 - Th1c1^{T} * Ah1c1 + Th1c1^{T} * Ah1h1
    // * Th1c1.
    copymtx = ASS_(myindex_p12, myindex_p12);
    copymtx -= Ac1h1T1;
    Transpose(Ac1h1T1, tmpmtx);
    copymtx -= tmpmtx;
    Gemm(TRANSPOSE, NORMAL, Scalar(1), T1, Ah1h1T1, Scalar(1), copymtx);
    ...
    SubMatrixTransposeUpdate(ASS_, myindex_p12, myindex_p11, copymtx);
    // Ac2c1 = Ac2c1 - Ac2h1 * Th1c1 - Th2c2^{T} * Ah2c1 + Th2c2^{T} * Ah2h1 *
    // Th1c1.
    copymtx = ANS_(myindex_p22, myindex_p12);
    Gemm(NORMAL, NORMAL, Scalar(-1), ANS_(myindex_p22, myindex_p11), T1,
         Scalar(1), copymtx);
    Gemm(TRANSPOSE, NORMAL, Scalar(-1), T2, ANS_(myindex_p21, myindex_p12),
         Scalar(1), copymtx);
    tmpmtx.Resize(myindex_p21.size(), T1.Width());
    Gemm(NORMAL, NORMAL, Scalar(1), ANS_(myindex_p21, myindex_p11), T1,
         Scalar(0), tmpmtx);
    Gemm(TRANSPOSE, NORMAL, Scalar(1), T2, tmpmtx, Scalar(1), copymtx);
    SubMatrixUpdate(ANS_, myindex_p22, myindex_p12, copymtx);
    SubMatrixTransposeUpdate(nodek.ANS_, nodekindex_p12, nodekindex_p22,
                             copymtx);
    ...
    SubMatrixTransposeUpdate(nodek.ANS_, nodekindex_p12, nodekindex_p21,
                             copymtx);
    // Ac2h1 = Ac2h1 - Th2c2^{T} * Ah2h1.
    copymtx = ANS_(myindex_p22, myindex_p11);
    Gemm(TRANSPOSE, NORMAL, Scalar(-1), T2, ANS_(myindex_p21, myindex_p11),
         Scalar(1), copymtx);
    SubMatrixUpdate(ANS_, myindex_p22, myindex_p11, copymtx);
    SubMatrixTransposeUpdate(nodek.ANS_, nodekindex_p11, nodekindex_p22,
                             copymtx);
    // Ac2c2 = Ac2c2 - Ah2c2^{T} * Th2c2 - Th2c2^{T} * Ah2c2 + Th2c2^{T} * Ah2h2
    // * Th2c2.
    copymtx = nodek.ASS_(nodekindex_p22, nodekindex_p22);
    copymtx -= Ac2h2T2;
    Transpose(Ac2h2T2, tmpmtx);
    copymtx -= tmpmtx;
    Gemm(TRANSPOSE, NORMAL, Scalar(1), T2, Ah2h2T2, Scalar(1), copymtx);
    ...
    SubMatrixTransposeUpdate(nodek.ASS_, nodekindex_p22, nodekindex_p21,
                             copymtx);
    ...
    Gemm(NORMAL, NORMAL, Scalar(-1), ASS_(myindex_p11, myindex_p12),
         nbinfo_[k].Ac1c1invAc1h1, Scalar(1), copymtx);
    SubMatrixUpdate(ASS_, myindex_p11, myindex_p11, copymtx);
    // Ac2h1 = Ac2h1 - Ac2c1 * Ac1c1^{-1} * Ah1c1^{T}.
    copymtx = ANS_(myindex_p22, myindex_p11);
    Gemm(NORMAL, NORMAL, Scalar(-1), ANS_(myindex_p22, myindex_p12),
         nbinfo_[k].Ac1c1invAc1h1, Scalar(1), copymtx);
    SubMatrixUpdate(ANS_, myindex_p22, myindex_p11, copymtx);
    SubMatrixTransposeUpdate(nodek.ANS_, nodekindex_p11, nodekindex_p22,
                             copymtx);
    ...
    Gemm(NORMAL, NORMAL, Scalar(-1), ANS_(myindex_p21, myindex_p12),
         nbinfo_[k].Ac1c1invAc1h1, Scalar(1), copymtx);
    SubMatrixUpdate(ANS_, myindex_p21, myindex_p11, copymtx);
    SubMatrixTransposeUpdate(nodek.ANS_, nodekindex_p11, nodekindex_p21,
                             copymtx);
    // Ac2c2 = Ac2c2 - Ac2c1 * Ac1c1^{-1} * Ac2c1^{T}.
    copymtx = nodek.ASS_(nodekindex_p22, nodekindex_p22);
    Gemm(NORMAL, NORMAL, Scalar(-1), ANS_(myindex_p22, myindex_p12),
         nbinfo_[k].Ac1c1invAc1c2, Scalar(1), copymtx);
    SubMatrixUpdate(nodek.ASS_, nodekindex_p22, nodekindex_p22, copymtx);
    ...
    Gemm(NORMAL, NORMAL, Scalar(-1), ANS_(myindex_p21, myindex_p12),
         nbinfo_[k].Ac1c1invAc1h2, Scalar(1), copymtx);
    ...
    Transpose(nodek.ASS_(nodekindex_p21, nodekindex_p22),
              nbinfo_[k].Ac2c2invAc2h2);
    MultiplySolve(nbinfo_[k].Ac2c2inv, nbinfo_[k].Ac2c2invAc2h2);
    // Ah1h1 = Ah1h1 - Ac2h1^{T} * Ac2c2^{-1} * Ac2h1.
    copymtx = ASS_(myindex_p11, myindex_p11);
    Gemm(TRANSPOSE, NORMAL, Scalar(-1), ANS_(myindex_p22, myindex_p11),
         nbinfo_[k].Ac2c2invAc2h1, Scalar(1), copymtx);
    SubMatrixUpdate(ASS_, myindex_p11, myindex_p11, copymtx);
    // Ah2h1 = Ah2h1 - Ah2c2 * Ac2c2^{-1} * Ac2h1.
    copymtx = ANS_(myindex_p21, myindex_p11);
    Gemm(NORMAL, NORMAL, Scalar(-1), nodek.ASS_(nodekindex_p21, nodekindex_p22),
         nbinfo_[k].Ac2c2invAc2h1, Scalar(1), copymtx);
    SubMatrixUpdate(ANS_, myindex_p21, myindex_p11, copymtx);
    SubMatrixTransposeUpdate(nodek.ANS_, nodekindex_p11, nodekindex_p21,
                             copymtx);
    ...
    copymtx = nodek.ASS_(nodekindex_p21, nodekindex_p21);
    Gemm(NORMAL, NORMAL, Scalar(-1), nodek.ASS_(nodekindex_p21, nodekindex_p22),
         nbinfo_[k].Ac2c2invAc2h2, Scalar(1), copymtx);
    SubMatrixUpdate(nodek.ASS_, nodekindex_p21, nodekindex_p21, copymtx);
    // Ah2c2 = Ac2h1 = 0.
...
// No skeletonization.
template <typename Scalar> void HIFGraph<Scalar>::NoSkel() {
