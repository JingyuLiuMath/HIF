...
template <typename Scalar> void HIFGraph<Scalar>::Factorization() {
  ...
  for (int tmplevel = numlevels_; tmplevel >= 1; tmplevel--) {
    ...
    INFO_HIF(Log(setw(13), tmplevel, setw(17), scientific, setprecision(2),
                 TimerPartial(TIMER_FACTOR), setw(14), scientific,
                 setprecision(2), TimerTotal(TIMER_EL), setw(18), scientific,
                 setprecision(2), TimerPartial(TIMER_SPARSEELIM), setw(12),
                 scientific, setprecision(2), TimerPartial(TIMER_SKEL),
                 setw(13), scientific, setprecision(2),
                 TimerPartial(TIMER_MERGE), setw(13), scientific,
                 setprecision(2), TimerTotal(TIMER_EL_LDLSOLVE), setw(12),
                 scientific, setprecision(2), TimerTotal(TIMER_EL_ID), setw(20),
                 scientific, setprecision(2),
                 TimerTotal(TIMER_SETOP) - setoptimecutoff);
             Log("--------------------------------------------------",
                 "--------------------------------------------------",
                 "--------------------------------------------------");)
  }
  ...
  INFO_HIF(Log(setw(13), 0, setw(17), scientific, setprecision(2),
               TimerTotal(TIMER_FACTOR), setw(14), scientific, setprecision(2),
               TimerTotal(TIMER_EL), setw(18), scientific, setprecision(2),
               TimerTotal(TIMER_SPARSEELIM), setw(12), scientific,
               setprecision(2), TimerTotal(TIMER_SKEL), setw(13), scientific,
               setprecision(2), TimerTotal(TIMER_MERGE), setw(13), scientific,
               setprecision(2), TimerTotal(TIMER_EL_LDLSOLVE), setw(12),
               scientific, setprecision(2), TimerTotal(TIMER_EL_ID), setw(20),
               scientific, setprecision(2),
               TimerTotal(TIMER_SETOP) - setoptimecutoff);
